...
Current stable release: [v0.3.0](https://github.com/DejavuMoe/edgeTTS/releases/tag/v0.3.0)
...
| --------------------------------------------------- | ----------------------------------------------------- | ----------------------------- |
| `ghcr.io/dejavumoe/edgetts:0.3.0`                   | Recommended for normal stable production deployments  | Release tag                   |
